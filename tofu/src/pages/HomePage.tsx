...
export const HomePage = () => {
  ...
  const handleInputChange = (inputText: any, inputNumber: number) => {
  ...
  const handleDropdownItemClick = (selectedCity: string, numberInput: number) => {
    if(numberInput === 1){
    ...
    <nav className="navbar navbar-expand-lg navbar-dark">
        <div className="container-fluid">
          <a className="navbar-brand mb-0" href="#">Tofu</a>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <a type="button" className="button-sign-in btn btn-outline-light" href="/signin">Sign in</a>
            
          </div>
        </div>
      </nav>
      <div className="text-white text-center py-5">
        <h1 className="header-h1">Find your comfortable way to home!
        </h1>
    </div>
        ...
        <div className="input-group mb-3">
            ...
            {isDropdownVisible && (
              ...
              {matchingCities.map(city => (
                <Dropdown.Item key={city} onClick={() => handleDropdownItemClick(city, 1)}>{city}</Dropdown.Item>
              ))}
              </Dropdown.Menu>
            )}
            <input type="text" value={searchTerm1}
                  onChange={(e)=> {handleInputChange(e.target.value, 2)
                    setSearchTerm1(e.target.value)}}
                  onClick={handleInputClick(2)} className="form-control" placeholder="To.." aria-label="To"/>
                  {isDropdownVisible1 && (
                    <Dropdown.Menu className='col-xs-0' id='dropdown-city' style={{marginTop: '35px', marginLeft: '160px'}} show>
                    {matchingCities.map(city => (
                      <Dropdown.Item key={city} onClick={() => handleDropdownItemClick(city, 2)}>{city}</Dropdown.Item>
                    ))}
                    </Dropdown.Menu>
                  )}
            <span className="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar2-day" viewBox="0 0 16 16">
            ...
            <input type="datetime-local" className="form-control w-25" placeholder="Start.." aria-label="Start"/>
            ...
            <input type="text" className="form-control" placeholder="1 Adult" aria-label="1 Adult"/>
      ...
      <div className="d-lg-none">
        <div className="container">
          ...
          <div className="input-group mb-3 col-md-6">
              <input type="text" className="form-control" placeholder="From..." aria-label="From"/>
              <span className="input-group-text">⇆</span>
              <div className="input-group mb-3 col-md-6"></div>
              <input type="text" className="col-1 form-control " placeholder="To.." aria-label="To"/>
            </div>
            <div className="input-group mb-3 col-md-6">
              <span className="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar2-day" viewBox="0 0 16 16">
                <path d="M4.684 12.523v-2.3h2.261v-.61H4.684V7.801h2.464v-.61H4v5.332h.684zm3.296 0h.676V9.98c0-.554.227-1.007.953-1.007.125 0 .258.004.329.015v-.613a1.806 1.806 0 0 0-.254-.02c-.582 0-.891.32-1.012.567h-.02v-.504H7.98v4.105zm2.805-5.093c0 .238.192.425.43.425a.428.428 0 1 0 0-.855.426.426 0 0 0-.43.43zm.094 5.093h.672V8.418h-.672v4.105z"/>
              ...
              <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
                <div className="col d-flex align-items-start">
                  <div className="icon-square  flex-shrink-0 me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-journal-check" viewBox="0 0 16 16">
                ...
                <div className="col d-flex align-items-start">
                  <div className="icon-square text-dark flex-shrink-0 me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-person-hearts" viewBox="0 0 16 16">
