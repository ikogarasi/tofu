...
export class CarrierClient extends ApiBase {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Carrier[]);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  addCarrier(request: CarrierDto | undefined): Promise<Carrier> {
    ...
    if (request === null || request === undefined)
      ...
      content_.append("title", request.title);
      content_.append("image", request.image);
      content_.append("description", request.description);
    }
...
export class TicketClient extends ApiBase {
  ...
  getTicketsByParameters(
    ...
    if (passangersAmount === null)
      ...
      url_ +=
        "passangersAmount=" + encodeURIComponent("" + passangersAmount) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetTicketsByParameters(
    response: Response
  ): Promise<Ticket[]> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Ticket[]);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
